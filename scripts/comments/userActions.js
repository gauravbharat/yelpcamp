  ...
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-body" style="overflow-y: auto;">
        ...
        <div class="embed-responsive embed-responsive-1by1" style="overflow: scroll;">
          <iframe class="embed-responsive-item" style="overflow: scroll;" src="/users/` + p_currentAuthorId + `/inCampComModal"></iframe>
        </div>
      </div>
